...
const AboutSection = () => {
  ...
  <motion.span
    ...
    className="block h-[2px] w-16 bg-green-500 -mt-1 ml-16 translate-x-4 origin-center rounded-full"
  ></motion.span>
</div>


          <p className="text-white font-poppins mb-6 leading-relaxed text-sm sm:text-base sm:text-center mt-3" style={{ textAlign: "justify" }}>
  ...
  <div className="flex flex-col items-center mb-6 group">
    <h3 className="text-xl sm:text-2xl font-semibold text-white font-poppins text-center">
        ...
        {!isVideoPlaying ? (
          <>
            ...
            <div className="relative z-10 text-center p-8">
              ...
              <p className="text-base sm:text-lg font-medium text-white font-poppins">
                Hover to play message
              </p>
              <p className="text-sm text-white font-poppins mt-2">
                Dr. Prashant Lokhande, TPO Officer
              </p>
            </div>
          </>
        ) : (
      ...
      <CardContent className="p-4 sm:p-8 flex-1 flex flex-col justify-between">
        <div className="flex flex-col items-center md:items-start relative w-full">
          <h3 className="text-xl sm:text-2xl font-semibold text-white font-poppins mb-2 mt-3 flex items-center gap-2 justify-center md:justify-start w-full max-w-max mx-auto md:mx-0">
            <Eye className="text-green-500 mr-0 md:mr-2 -mt-2" size={24} />
           <span className="relative inline-block text-center group">
  ...
  <motion.div {...fadeIn(0.4)}>
    <Card className="bg-[#0d0d0d] border border-gray-800 shadow-xl h-full flex flex-col">
      <CardContent className="p-4 sm:p-8 flex-1 flex flex-col justify-between">
        <div className="flex flex-col items-center md:items-start relative w-full">
          <h3 className="text-xl sm:text-2xl font-semibold text-white font-poppins mb-2 mt-3 flex items-center gap-2 justify-center md:justify-start w-full max-w-max mx-auto md:mx-0">
            <Activity className="text-green-500 mr-0 md:mr-2 -mt-1" size={24} />
            <span className="relative inline-block text-center group">
